...
module.exports = {
  ...
  edit: {
    ...
    pr: (messageID) =>
      `${e.success} تم تحديث جائزة الهبة بنجاح. \n${e.hash} معرف الهبة: \`${messageID}\``,
    wi: (messageID) =>
      `${e.success} تم تحديث الفائز(ة) بالهبة بنجاح. \n${e.hash} معرف الهبة: \`${messageID}\``,
    ti: (messageID) =>
      `${e.success} تم تحديث مدة الهبة بنجاح. \n${e.hash} معرف الهبة: \`${messageID}\``,
    errmod: `${e.error} حدث خطأ ما!`,
    ending: " النهاية ",
    ...
    errmod: `${e.error} حدث خطأ ما!`,
    good: (messageID) =>
      `${e.success} تم إنهاء الهبة بنجاح. \n${e.hash} معرف الهبة: \`${messageID}\``,
  ...
  pause: {
    ...
    forpause: `${e.for} **لتوقيف الهبة:**`,
      ...
      `${e.success} تم توقيف الهدية بنجاح! \n${e.hash} معرف الهبة: \`${messageID}\``,
    errmod: `${e.error} حدث خطأ ما!`,
  },
  ...
  resume: {
    ...
    forresume: `${e.for} **لاستئناف الهبة:**`,
      ...
      `${e.success} تم استئناف الهدية بنجاح! \n${e.hash} معرف الهبة: \`${messageID}\``,
    errmod: `${e.error} حدث خطأ ما!`,
  },
  ...
  messages: {
    ...
    serverreq: (servername, serverrequired) =>
      `・${e.serverreq} الخادم: [${servername}](${serverrequired})`,
...
${e.bot_logo}**`,
  ...
  setrole: {
    ...
    roledone: (role) =>
      `${e.success} | تم تعين الرتبة الآتية كمدير للهبات: ||<@&${role.id}>||, و \`مفعل\``,
  ...
  lastchance: {
    content: `${e.warning} **أخر فرصة لدخول في السحب!** ${e.warning}`,
  },
  ...
  blacklist: {
    user: (ureason) =>
      `${e.warning} **لا يمكنك استخدام أوامر ManageGift** \n \`\`\`السبب: ${ureason}\`\`\` \n**إذا كنت تعتقد أن هذا خطأ أو شيء من هذا القبيل، لا تتردد في تقديم اعتراضك في [خدمة الدعم الفني](https://discord.gg/7XfV4Md)**`,
    guild: (sreason) =>
      `${e.warning} **هذا الخادم موجود في القائمة السوداء، لا يمكنك استخدام أي أمر فيه**\n \`\`\`السبب: ${sreason}\`\`\` \n**إذا كنت تعتقد أن هذا خطأ أو شيء من هذا القبيل، لا تتردد في تقديم اعتراضك في [خدمة الدعم الفني](https://discord.gg/7XfV4Md)**`,
  },

  moved: {
    update: `${e.news} تحديث!`,
    slash:
      "من الإصدار `v4.0.0` فصاعداً تم تحويل أوامر **ManageGift** إلى **أوامر السلاش**! الرجاء كتابة `/help` للتعرف على جميع الأوامر!",
  },
  dashboard: {
