...
module.exports = {
  ...
  run: async (client, interaction, guildData, lang) => {
    ...
    if (
      ...
      return interaction.editReply(lang.cmd.botperm);
    }
    ...
    // Create the giveaway
    try {
      const drop = await client.manager.start(targetChannel, {
        isDrop: true,
        prize: giveawayPrize,
            ...
            components: [
              new Discord.ActionRowBuilder().addComponents(
                new Discord.ButtonBuilder()
                  ...
                  .setURL(
                    `https://discord.com/channels/${interaction.guildId}/${targetChannel.id}/`
                  )
      ...
      return await interaction.editReply({
        content: lang.drop.dropstart,
        components: [btn],
      });
    } catch (err) {
      client.log("Drop Start Error:", "error");
      console.error(err);
      return interaction.editReply({
        content: "An error occurred while creating the drop.",
      });
    }
  },
};
